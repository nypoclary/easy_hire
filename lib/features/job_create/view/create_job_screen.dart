...
class _CreateJobScreenState extends ConsumerState<CreateJobScreen> {
  ...
  final List<String> categories = [
    'Office', 'Accounting', 'Sales', 'Support', 'Teaching', 'IT',
    'Technical', 'Driving', 'Delivery', 'Cleaning', 'Security',
    'Healthcare', 'Restaurant', 'Construction', 'Design',
  ];

  final List<String> workModes = ['Remote', 'Full Time', 'Part Time'];
  final List<String> locations = [
    'Yangon', 'Mandalay', 'Naypyitaw', 'All', 'Mawlamyine', 'Bago', 'Sagaing'
  ];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _popupRow('Location', selectedLocation, locations, (val) => setState(() => selectedLocation = val)),
                _formRow(
                  'Salary',
                ...
                _formRow(
                  'Job Type',
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) return 'Job Type is required';
                ...
                _popupRow('Work Mode', selectedWorkMode, workModes, (val) => setState(() => selectedWorkMode = val)),
                ...
                _inputField(maxLines: 4, controller: requirementsController),
                const SizedBox(height: 24),
                _sectionHeader('Responsibilities'),
                _inputField(maxLines: 4, controller: responsibilitiesController),
  ...
  Widget _popupRow(String label, String? selected, List<String> options, ValueChanged<String> onSelected) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _label(label),
  ...
  Widget _categoryDropdown() {
    return GestureDetector(
      onTap: () => _showPopupDialog('Category', categories, (val) => setState(() => selectedCategory = val)),
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        decoration: BoxDecoration(
          border: Border.all(color: lightPurple),
  ...
  Widget _inputField({int maxLines = 1, TextEditingController? controller}) {
